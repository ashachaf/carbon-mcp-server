...
export type RetypeProps<T, From, To> = {
    [K in keyof T]: T[K] extends From ? To : T[K] extends object ? RetypeProps<T[K], From, To> : T[K];
};
...
export interface Fetcher {
    ...
    onTradingFeePPMUpdated(listener: (prevFeePPM: number, newFeePPM: number) => void): void;
